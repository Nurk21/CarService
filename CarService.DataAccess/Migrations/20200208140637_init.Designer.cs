            ...
            modelBuilder.Entity("CarService.Core.Entities.VehicleType.Bus", b =>
                {
                    ...
                    b.HasOne("CarService.Core.Entities.DetailsType.Cabin", "CabinId")
                        .WithMany()
                        .HasForeignKey("CabinIdId");

                    b.HasOne("CarService.Core.Entities.DetailsType.Cabin", "Cabin")
                        .WithOne("Bus")
                        .HasForeignKey("CarService.Core.Entities.VehicleType.Bus", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
